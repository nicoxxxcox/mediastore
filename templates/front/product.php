            ...
            <div class="card shadow ">
                ...
                echo '
                    ...
                    <div class="card-body">
                       ...
                       <a href="?page=' . $_GET['page'] . '&categorie=' . $_GET['categorie'] . '&product=' . $prod['id_product'] . '&addcart=' . $prod['id_product'] . '" class="btn btn-success"><i class="fas fa-cart-plus"></i> Ajouter au panier</a>
                       </div>
                </div>
            </div>
            <div class="col-sm-4 my-4 shadow" style="background-size: cover;background-image: url(' . $prod["url_product"] .'); " >
