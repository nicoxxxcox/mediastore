        ...
        <div class=\"row\">        
            <div class=\"col-sm-6 mx-auto mt-5\">            
                ...
                <form class=\"form-signin p-3 \" method='post' action='functions.php' >
                    ...
                    <input type=\"password\" name=\"passmod\" id=\"inputPassword\" class=\"form-control text-primary mb-2\" placeholder=\"Mot de passe\" value=\"".$infosall['pass_user'].'"  included >
                    ...
                    <input type=\"text\" name=\"idmod\" id=\"inputAdress\" class=\"form-control text-primary mb-2\" placeholder=\"Code postal\"
